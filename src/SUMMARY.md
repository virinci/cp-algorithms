...
- [Fundamentals](algebra/binary-exp.md)
...
- [Prime numbers](algebra/sieve-of-eratosthenes.md)
...
- [Number systems](algebra/balanced-ternary.md)
    - [Balanced Ternary](algebra/balanced-ternary.md)
    - [Gray code](algebra/gray-code.md)
- [Miscellaneous](algebra/bit-manipulation.md)
